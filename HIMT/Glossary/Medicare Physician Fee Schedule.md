...
The MPFS is the primary method of payment for enrolled health care professionals. Specifically, [Medicare](medicare.md) uses the [MPFS](mpfs.md) when paying the following services: 
...
Medicare also pays suppliers like Mammography Centers according to the [MPFS](mpfs.md). [Medicare](medicare.md) pays Institutional providers like hospitals, Comprehensive Outpatient Rehabilitation Facilities (CORFs), and Skilled Nursing Facilities (SNFs) for some services under the [MPFS](mpfs.md), depending on the institution type and service. For example, [Medicare](medicare.md) pays hospital outpatient departments for screening mammographies, and outpatient rehabilitation services, under the [MPFS](mpfs.md). 

The MPFS Look-Up Tool helps health care professionals, suppliers, and institutional providers find [Medicare](medicare.md) payment amounts for each code so they can calculate the [Beneficiary](beneficiary.md) coinsurance amount. The MPFS gives the limiting charge for nonparticipating health care professionals and suppliers who treat [Medicare](medicare.md) beneficiaries. 

The [MPFS](mpfs.md) is an excellent way to learn if [HCPCS](hcpcs-level-ii.md) codes are affected by payment policies like: 
...
## Participating
Participating Health Care Professionals and Suppliers enrolled in [Medicare](medicare.md) and signed the Form CMS-460, Medicare Participating Physician or Supplier Agreement, agreeing to charge no more than [Medicare](medicare.md)-approved amounts and deductibles and coinsurance amounts. Participating professionals and suppliers submit assigned claims.

### Assigned claims
Health professionals, suppliers and providers submit Assigned Claims on behalf of the [Beneficiary](beneficiary.md). [Medicare](medicare.md) issues payment to the submitter. 

## Non PAR
Nonparticipating Health Care Professionals and Suppliers enrolled in Medicare but decided not to sign the Form CMS-460. They accept assignment on a case-by-case basis. For services paid under the [MPFS](mpfs.md), [Medicare](medicare.md) reduces (5%) the [Medicare](medicare.md)-approved amounts for nonparticipants. Also, [Medicare](medicare.md) limits what the health care professional or supplier may charge the beneficiary (Limiting Charge) when they choose not to accept assignment on the claim. 

### Limiting Charge
Limiting Charge equals 115% of the nonparticipating fee schedule amount and is the maximum the nonparticipant may charge a [Beneficiary](beneficiary.md) on an unassigned claim. The nonparticipating [Fee schedule](fee-schedule.md) amount is equal to 95% of the [Medicare](medicare.md) Physician Fee Schedule. 

### Unassigned Claims
Nonparticipating health care professionals or suppliers not accepting assignment on the claim submit Unassigned Claims. [Medicare](medicare.md) issues payment to the [Beneficiary](beneficiary.md). Use the [MPFS](mpfs.md) Look-Up Tool to learn if payment policies such as payment of assistant at surgery services, applicability of certain modifiers, and physician supervision of diagnostic services affect HCPCS codes.
...
- Medicare reduces the [Medicare](medicare.md)-approved amounts for nonparticipating health care professionals and suppliers by 5%. In other words, the amounts in this column add up to 115% of 95% of the amounts in column 5.
- Facility Limiting Charge: $105.13 is shown for 99214 and $154.64 for 99215. This is the maximum amount the providers listed below may charge a [Beneficiary](beneficiary.md) for the service:
	- Nonparticipating health care professionals
	- Providers who don’t accept assignment
	- Providers who perform the service in a facility setting
- For the technical component of certain diagnostic imaging procedures, [Medicare](medicare.md) bases payment on the lower of the Outpatient Prospective Payment System (OPPS) cap or [Fee schedule](fee-schedule.md) amount; however, the MPFS search results don’t reflect payment [Adjustments](adjustments.md). The MPFS Look-Up Tool displays full payments as well as OPPS payments. Also, the MPFS Look-Up Tool can’t display Multiple Procedures Payment Reductions (MPPRs) since too many combinations of [HCPCS](hcpcs-level-ii.md) codes exist.
- BILT SURG – This column displays a 0, which means the 150% payment adjustment for bilateral procedure doesn’t apply. The [MPFS](mpfs.md) bases [Relative Value Unit (RVU)](relative-value-unit-rvu.md) on the procedure providers perform as a bilateral procedure. If you report the procedure with [Modifier](modifier.md) 50 or report it twice on the same day (for example, with RT and LT [modifiers](modifiers.md) with a 2 in the units field), [Medicare](medicare.md) bases payment for both sides on the lower of (a) the total actual charges for both sides or (b) 100% of the [Fee schedule](fee-schedule.md) amount for a single code.
